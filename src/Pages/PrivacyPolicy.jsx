...
import { privacyPolicyPageContentApi } from "../Api/Api";
...
const PrivacyPolicy = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await axios.get(privacyPolicyPageContentApi , {})
    ...
    <div className="py-sectionSm md:py-sectionMd lg:py-sectionLg xl:py-sectionLg bg-secondary ">
      <Container>
        <div className="flex items-center justify-between pb-sectionSm lg:pb-sectionMd">
          <SectionTitle className="font-semibold !text-primary" text="Privacy Policy" />
          {/* <Breadcrumb /> */}
        </div>
