...
import { api, singleDepartmentApi } from "../Api/Api"; // Ensure this is correct
...
const SingleDepartment = () => {
  ...
  useEffect(() => {
    const fetchDepartment = async () => {
      try {
        ...
        // Check if the department has translations
  ...
  if (loading) return <Container className="py-sectionSm md:py-sectionMd lg:py-sectionLg xl:py-sectionLg">
    <div
      className="">
  ...
  console.log(department.gallery);
    ...
    <div className="">
      ...
      <div className="bg-theme bg-opacity-[0.3]">
        <Container>
          <div className="py-sectionSm md:py-sectionMd lg:py-sectionLg xl:py-sectionLg">
            ...
            <p className="mt-3">Cardiology encompasses a broad range of conditions affecting the heart and blood vessels, including:</p>
            {department.services.map((service, index) => (
              <ul className="ml-5 mt-2.5" key={index}>
                <li className="list-disc">{service.name}</li>
              </ul>
            ))}
          </div>
        </Container>
      ...
      <Container>
        ...
        <MinTitle
          ...
          text="Our commitment to excellence has earned us recognition as one of the nation's top healthcare providers."
        />
        {loading ? (
      ...
      <div className="bg-theme bg-opacity-[0.3] pt-9 pb-16">
        <Container>
          <SectionTitle className="text-center mt-10" text="case study" />
          <MinTitle
            className="text-center mt-2 w-96 mx-auto mb-5"
            text="Case Studies That Inspire Confidence"
          />
      ...
      <Container>
        <SectionTitle className="text-center mt-10" text="Gallery" />
        <MinTitle
          className="text-center mt-2 w-96 mx-auto mb-5"
          text="Our commitment to excellence has earned us recognition as one of the nation's top healthcare providers."
        />
