...
const ReletedBlogCard = ({ id, title, thumbnail, publishedDate, slug }) => {
      ...
      <div onClick={fetchBlogDetails} key={id} className="group cursor-pointer">
        ...
        >
          ...
          <div className="col-span-3 sm:col-span-5 md:col-span-5 lg:col-span-4 py-[2px]">
            <ExtraMinTitle
              className=" font-medium text-tertiary group-hover:text-theme duration-500"
...
export default ReletedBlogCard;
